...
Network = newff(PR,[11 30 27 OutputNum],{'tansig' 'tansig' 'tansig' 'purelin'});
...
YtrN(:,1)=(((YtrNet(:,1)+1)/2)*(63.15-25))+25;
YtsN(:,1)=(((YtsNet(:,1)+1)/2)*(63.15-25))+25;
Ytrr(:,1)=(((Ytr(:,1)+1)/2)*(63.15-25))+25;
Ytsr(:,1)=(((Yts(:,1)+1)/2)*(63.15-25))+25;
%% Display
figure(1)
plot(Ytr,'-or');
hold on
...
figure(5)
[m,b,r]=postreg(YtsN,Ytsr)
hold off

figure(6)
[m,b,r]=postreg(YtrN,Ytrr)
hold off
